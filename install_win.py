...
moduleName = "KeyRingManager"
authorName = "Relena"
contributorsName = [] # List of String
descriptionShort = "A new interface to manage the 'Bunch of keys'"
description = "A new interface to manage the 'Bunch of keys'"
categories = "GUI" # CSV format
